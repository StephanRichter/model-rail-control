...
############################# BR 110
    ...
    elif (BR86.stat(PARKED) and BR110.stat(BEREIT,LINKS,2) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        BR110.status=AUSFAHRT
        BR110.nachGleis=1
        start_new_thread(BR110.ausfahrt,(pause,))

    elif (BR86.stat(PARKED) and BR110.stat(BEREIT,RECHTS,1) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        BR110.status=GLEISWECHSEL
        BR110.nachGleis=2
        start_new_thread(BR110.gleiswechsel,(pause,))
    elif (BR86.stat(PARKED) and BR110.stat(BEREIT,RECHTS,2) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        BR110.status=AUSFAHRT
        BR110.nachGleis=1
        start_new_thread(BR110.ausfahrt,(pause,))
    elif (BR86.stat(PARKED) and BR110.stat(BEREIT,RECHTS,3) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        BR110.status=GLEISWECHSEL
        BR110.nachGleis=4
        start_new_thread(BR110.gleiswechsel,(pause,))
    elif (BR86.stat(PARKED) and BR110.stat(BEREIT,RECHTS,4) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        BR110.status=GLEISWECHSEL
        BR110.nachGleis=1
        start_new_thread(BR110.gleiswechsel,(pause,))

    
    elif (BR86.stat(PARKED) and BR110.stat(EINFAHRT,LINKS,1) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(EINFAHRT,LINKS,2) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(EINFAHRT,LINKS,3) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
        ...
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(GLEISWECHSEL,LINKS,2) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(GLEISWECHSEL,RECHTS,1) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(GLEISWECHSEL,RECHTS,2) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(GLEISWECHSEL,RECHTS,3) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(GLEISWECHSEL,RECHTS,4) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()

    elif (BR86.stat(PARKED) and BR110.stat(NACH_LINKS,RECHTS,1) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(NACH_LINKS,RECHTS,2) and BR118.stat(PARKED) and BR130.stat(PARKED)):
        reset()
...
###################################### BR ICE
    ...
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(AUSFAHRT,LINKS,1)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(AUSFAHRT,LINKS,2)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(BEREIT,LINKS,1)):
        ...
        ICE.nachGleis=1
        start_new_thread(ICE.ausfahrt,(pause,))
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(BEREIT,RECHTS,2)):
        ICE.status=GLEISWECHSEL
        ICE.nachGleis=3
        start_new_thread(ICE.gleiswechsel,(pause,))
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(BEREIT,RECHTS,3)):
        ICE.status=GLEISWECHSEL
        ICE.nachGleis=4
        start_new_thread(ICE.gleiswechsel,(pause,))
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(BEREIT,RECHTS,4)):
        ICE.status=GLEISWECHSEL
        ICE.nachGleis=1
        start_new_thread(ICE.gleiswechsel,(pause,))


    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(EINFAHRT,LINKS,1)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(EINFAHRT,LINKS,2)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(EINFAHRT,LINKS,3)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(EINFAHRT,LINKS,4)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(EINFAHRT,RECHTS,1)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(EINFAHRT,RECHTS,2)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(GLEISWECHSEL,LINKS,1)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(GLEISWECHSEL,LINKS,2)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(GLEISWECHSEL,RECHTS,1)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(GLEISWECHSEL,RECHTS,2)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(GLEISWECHSEL,RECHTS,3)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(GLEISWECHSEL,RECHTS,4)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(NACH_LINKS,RECHTS,1)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(NACH_LINKS,RECHTS,2)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(NACH_LINKS,RECHTS,3)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(NACH_LINKS,RECHTS,4)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(NACH_RECHTS,LINKS,1)):
        reset()
    elif (BR86.stat(PARKED) and BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(NACH_RECHTS,LINKS,2)):
        reset()
