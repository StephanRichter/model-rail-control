...
while True:    
    ...
    if BR86.stat(ABGEKUPPELT,LINKS,1):
        if BR110.stat(AUSFAHRT,LINKS,2):
            if BR118.stat(BEREIT,RECHTS,1):
                if BR130.stat(ABGEKUPPELT,RECHTS,3):
                    ...
                    err()
            elif BR118.stat(BEREIT,RECHTS,4):
                if BR130.stat(ABGEKUPPELT,RECHTS,3):
            ...
            if BR118.stat(BEREIT,RECHTS,1):
                ...
                if BR130.stat(ABGEKUPPELT,RECHTS,3):
                    if ICE.stat(BEREIT,RECHTS,1):
                        ...
                        if rand==1:
                            ...
                            BR118.startGleiswechsel(1,pause)
                        else:
                ...
                err()
        elif BR110.stat(BEREIT,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4):
            if BR130.stat(ABKUPPELN,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
                reset()
            elif BR130.stat(ABGEKUPPELT,RECHTS,3):
            ...
            if BR118.stat(BEREIT,RECHTS,1):
                if BR130.stat(ABGEKUPPELT,RECHTS,3):
                    ...
                    err()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
                rand=random.choice([1,2,3,4])
                rand=2
                print "z314"
                print "rand =",rand
            ...
            if BR118.stat(BEREIT,RECHTS,1):
                ...
                err()
        elif BR110.stat(EINFAHRT,LINKS,1) and BR118.stat(BEREIT,RECHTS,4):
            if BR130.stat(ABGEKUPPELT,RECHTS,3):
                if ICE.stat(BEREIT,RECHTS,1):
                    reset()
                elif ICE.stat(BEREIT,RECHTS,2):
            ...
            if BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
                ...
                err()
        elif BR110.stat(NACH_LINKS,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4):
            if BR130.stat(ABGEKUPPELT,RECHTS,3):
        ...
        if BR110.stat(AUSFAHRT,LINKS,1):
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(NACH_LINKS,RECHTS,1):
                reset()
            elif BR118.stat(NACH_LINKS,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                reset()
            else:
                err()
        elif BR110.stat(AUSFAHRT,LINKS,2):
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(NACH_LINKS,RECHTS,1):
                reset()
            elif BR118.stat(NACH_LINKS,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                reset()
                ...
                err()
        elif BR110.stat(BEREIT,LINKS,1):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                ...
                if BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
                    ...
                    if rand==1:
                        ...
                        BR110.startAusfahrt(4,pause)
                        BR118.startAusfahrt(1,pause+13)
                    elif rand==4:
                        BR110.startAusfahrt(1,pause)
                        ICE.startAusfahrt(2,pause+13)
                    else:
            ...
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                ...
                if rand==1:
                    ...
                    ICE.startAusfahrt(1,pause)
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
                if ICE.stat(BEREIT,LINKS,1):
                    rand=random.choice([1,2,3,4,5])
                    rand=2
                    print "z563"
            ...
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
                if ICE.stat(BEREIT,LINKS,1):
                    rand=random.choice([1,2,3,4,5,6])
                    rand=4
                    print "z532"
            ...
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
                ...
                err()
        elif BR110.stat(EINFAHRT,RECHTS,1):
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
                if ICE.stat(BEREIT,LINKS,1):
                    reset()
                elif ICE.stat(EINFAHRT,LINKS,1):
            ...
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
                ...
                err()
        elif BR110.stat(GLEISWECHSEL,LINKS,1):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                reset()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
                reset()
            ...
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
                ...
                err()
        elif BR110.stat(NACH_RECHTS,LINKS,1):
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
                if ICE.stat(BEREIT,LINKS,2):
                    reset()
                elif ICE.stat(EINFAHRT,LINKS,1):
        ...
        if BR110.stat(BEREIT,LINKS,2) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
            reset()
        elif BR110.stat(BEREIT,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
            if ICE.stat(BEREIT,LINKS,2):
                reset()
            elif ICE.stat(BEREIT,RECHTS,2):
                reset()
                ...
                err()
        elif BR110.stat(BEREIT,RECHTS,2) and BR118.stat(BEREIT,RECHTS,1) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            reset()
        ...
        if BR110.stat(BEREIT,LINKS,1):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                ...
                err()
        elif BR110.stat(BEREIT,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,1):
            reset()
        elif BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(PARKED):
            reset()
        else:
        ...
        if BR110.stat(BEREIT,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4):
            if BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,2):
                reset()
            elif BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,RECHTS,2):
                reset()
            else:
                err()
        elif BR110.stat(BEREIT,RECHTS,2):
        ...
        if BR110.stat(BEREIT,LINKS,1) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            reset()
        elif BR110.stat(BEREIT,LINKS,2):
            if BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,1):
                reset()            
            elif BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                reset()
            else:
        ...
        if BR110.stat(NACH_LINKS,RECHTS,2):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                reset()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
                reset()
            ...
            reset()
        elif BR110.stat(BEREIT,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(NACH_LINKS,RECHTS,2):
            reset()
        ...
        if BR110.stat(AUSFAHRT,LINKS,2):
            ...
            if BR118.stat(ABGEKUPPELT,RECHTS,2) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
                ...
                if rand==1:
                    ...
                    ICE.startAusfahrt(4,pause)
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,RECHTS,2):
                rand=random.choice([1,2,3,4,5,6])
                rand=2
                print "z818"
                print "rand =",rand
        ...
        if BR110.stat(BEREIT,LINKS,2):
            if BR118.stat(ABGEKUPPELT,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
                ...
                if rand==1:
                    ...
                    BR118.startGleiswechsel(3,pause)
                else:
                    ICE.startGleiswechsel(3,pause)
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,RECHTS,2):
                rand=random.choice([1,2,3,4,5,6])
                rand=2
                print "z1140"
                print "rand =",rand
                ...
                err()
        elif BR110.stat(BEREIT,RECHTS,2) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
            rand=random.choice([1])
            rand=2
            print "z1180"
            print "rand =",rand
            if rand==1:
                ...
                BR110.startGleiswechsel(3,pause)
            elif rand==5:
                BR118.startGleiswechsel(3,pause)
            else:
            ...
            if BR118.stat(ABGEKUPPELT,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
                ...
                if rand==1:
                    ...
                    ICE.startAusfahrt(2,pause)
            elif BR118.stat(ABGEKUPPELT,RECHTS,2) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
                rand=random.choice([1,2,3,4,5])
                rand=2
                print "z1144"
                print "rand =",rand
        ...
        if BR110.stat(AUSFAHRT,LINKS,2):
            if BR118.stat(ABGEKUPPELT,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3):
                ...
                err()
        elif BR110.stat(BEREIT,LINKS,1) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            rand=random.choice([1,2,3,4,5,6,7])
            rand=2
            print "z1809"
            print "rand =",rand
            ...
            if BR118.stat(ABGEKUPPELT,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3):
                ...
                if BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,RECHTS,1):
                    ...
                    if rand==1:
                        ...
                        ICE.startGleiswechsel(3,pause)
                elif BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,1):
            ...
            if BR118.stat(ABGEKUPPELT,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3):
                if ICE.stat(BEREIT,LINKS,2):
                    ...
                    err()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
                rand=random.choice([1])
                rand=2
                print "z1461"
                print "rand =",rand
        ...
        if BR110.stat(AUSFAHRT,LINKS,2):
            if BR118.stat(ABGEKUPPELT,RECHTS,2):
                ...
                if ICE.stat(BEREIT,RECHTS,1):
                    ...
                    err()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1):
                if ICE.stat(BEREIT,RECHTS,1):
                    reset()
                elif ICE.stat(BEREIT,RECHTS,2):
                    reset()
            ...
            if BR118.stat(ANKUPPELN,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,RECHTS,4):
                reset()
            elif BR118.stat(ABGEKUPPELT,RECHTS,2):
                if BR130.stat(ABGEKUPPELT,LINKS,1):
                    if ICE.stat(BEREIT,RECHTS,1):
                        rand=random.choice([1,2,3,4,5])                        
                        print "Zufall 1792"
                ...
                elif BR130.stat(ABKUPPELN,LINKS,1) and ICE.stat(BEREIT,RECHTS,1):
                    reset()
                else:
                    err()                    
            elif BR118.stat(BEREIT,RECHTS,1):
                ...
                if  ICE.stat(BEREIT,RECHTS,1):
                    ...
                    if rand==1:
                        ...
                        BR118.startGleiswechsel(4,pause)
                    else:
                        ICE.startGleiswechsel(4, pause)
                elif ICE.stat(BEREIT,RECHTS,4):
                    rand=random.choice([1,2,3,4,5,6])                    
            ...
            if BR118.stat(ABGEKUPPELT,RECHTS,2):
                ...
                if BR130.stat(ABGEKUPPELT,LINKS,1):
                    ...
                    reset()
                elif BR130.stat(BEREIT,LINKS,1) and ICE.stat(BEREIT,RECHTS,2):
                    rand=random.choice([1,2,3,4])
                    rand=2
                    print "z2373"
                    print "rand =",rand
                    if rand==1:
                        BR86.startAusfahrt(1,pause)
                        BR130.startAusfahrt(3,pause+4)
                    elif rand==2:
                        BR110.startAusfahrt(2,pause)
                    elif rand==3:
                        BR130.startGleiswechsel(2, pause)
                    else:
                        ICE.startAusfahrt(2,pause)                        
                    ...
                    err()
            elif BR118.stat(GLEISWECHSEL,RECHTS,2) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
                reset()
            elif BR118.stat(GLEISWECHSEL,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
                reset()
            else:
                err()
        elif BR110.stat(BEREIT, RECHTS, 2):
            ...
            if BR118.stat(ABGEKUPPELT,RECHTS,2):
                ...
                err()
        elif BR110.stat(EINFAHRT,LINKS,2):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(EINGEFAHREN,LINKS,1) and ICE.stat(BEREIT,RECHTS,4):
                reset()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1):
                if ICE.stat(BEREIT,RECHTS,1):
                    reset()
            ...
            if BR118.stat(BEREIT,RECHTS,2) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
                reset()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
                reset()
            else:
                err()
        elif BR110.stat(GLEISWECHSEL,RECHTS,2) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
            reset()
        elif BR110.stat(GLEISWECHSEL,RECHTS,4) and BR118.stat(BEREIT,RECHTS,2) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
            reset()
        elif BR110.stat(NACH_LINKS,RECHTS,1):
            if BR118.stat(ABGEKUPPELT,RECHTS,2):
                if BR130.stat(ABGEKUPPELT,LINKS,1):
                ...
                err()
        elif BR110.stat(NACH_LINKS,RECHTS,2):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(EINGEFAHREN,LINKS,1) and ICE.stat(BEREIT,RECHTS,4):
                reset()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,LINKS,1):
                if ICE.stat(AUSFAHRT,LINKS,2):
        ...
        if BR110.stat(AUSFAHRT,LINKS,2):
            if BR118.stat(ABGEKUPPELT,RECHTS,2) and BR130.stat(EINGEFAHREN,LINKS,1):
                ...
                reset()
            elif BR118.stat(BEREIT,RECHTS,4) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,2):
                reset()
            else:
                err()            
        elif BR110.stat(BEREIT,LINKS,2):
            if BR118.stat(ABGEKUPPELT,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
                ...
                if BR130.stat(ABGEKUPPELT,LINKS,1):
                    ...
                    err()
            elif BR118.stat(BEREIT,RECHTS,2) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,RECHTS,1):
                rand=random.choice([1,2,3,4,5])
                rand=2
                print "z2648"
                print "rand =",rand
        ...
        if BR110.stat(BEREIT,LINKS,2) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
            if ICE.stat(BEREIT,RECHTS,1):
                reset()
            elif ICE.stat(EINFAHRT,RECHTS,1):
                reset()
            ...
            if BR118.stat(EINFAHRT,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
                ...
                err()
        elif BR110.stat(EINFAHRT,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            reset()            
        elif BR110.stat(NACH_RECHTS,LINKS,1) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            reset()
        elif BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(PARKED):
            reset()
        else:
        ...
        if BR110.stat(BEREIT,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4):
            if BR130.stat(EINFAHRT,RECHTS,1) and ICE.stat(BEREIT,RECHTS,2):
                reset()
            elif BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,RECHTS,2):
                reset()
            else:
        ...
        if BR110.stat(BEREIT,LINKS,2):
            ...
            if BR118.stat(ABGEKUPPELT,RECHTS,2) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
                reset()
            elif BR118.stat(BEREIT,RECHTS,2) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,LINKS,2):
                reset()
            else:
        ...
        if BR110.stat(AUSFAHRT,LINKS,1) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            reset()
        elif BR110.stat(BEREIT,LINKS,2) and BR118.stat(BEREIT,RECHTS,4) and BR130.stat(EINGEFAHREN,RECHTS,3):
            if ICE.stat(AUSFAHRT,LINKS,1):
                reset()
            elif ICE.stat(EINFAHRT,RECHTS,1):
                reset()
        ...
        if BR110.stat(BEREIT,RECHTS,1) and BR118.stat(BEREIT,RECHTS,4):
            if BR130.stat(AUSFAHRT,LINKS,1) and ICE.stat(BEREIT,RECHTS,2):
                reset()
            elif BR130.stat(EINFAHRT,RECHTS,1) and ICE.stat(BEREIT,RECHTS,2):
                reset()
            elif BR130.stat(NACH_RECHTS,LINKS,1) and ICE.stat(BEREIT,RECHTS,2):
                reset()
            else:
                err()  
        elif BR110.stat(PARKED) and BR118.stat(PARKED) and BR130.stat(PARKED) and ICE.stat(PARKED):
