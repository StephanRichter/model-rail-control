    ...
    if BR86.stat(ABGEKUPPELT,LINKS,1):
        if BR110.stat(AUSFAHRT,LINKS,2) and BR118.stat(BEREIT,RECHTS,1):
            ...
            if BR130.stat(ABGEKUPPELT,RECHTS,3):
                ...
                err()
        elif BR110.stat(BEREIT,RECHTS,4) and BR118.stat(BEREIT,RECHTS,1):
        ...
        elif BR110.stat(BEREIT,RECHTS,4) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            rand=random.choice([1,2,3,4,5,6])
            rand=2
            print "z705"
            print "rand =",rand
        ...
        if BR110.stat(AUSFAHRT,LINKS,2):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1):
                if ICE.stat(BEREIT,RECHTS,4):
                    reset()
            ...
            if BR118.stat(BEREIT,RECHTS,1):
                ...
                err()
        elif BR110.stat(BEREIT,RECHTS,1) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3):
            if ICE.stat(BEREIT,LINKS,2):
            ...
            if BR130.stat(ABGEKUPPELT,LINKS,1):
                ...
                err()
        elif BR110.stat(BEREIT,RECHTS,4) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3):
            if ICE.stat(BEREIT,LINKS,2):
                rand=random.choice([1,2,3,4,5,6])
                rand=3
                print "z915"
        ...
        elif BR110.stat(EINFAHRT,LINKS,1) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3):
            if ICE.stat(BEREIT,RECHTS,1):
                reset()
            elif ICE.stat(BEREIT,RECHTS,4):
                reset()
            ...
            reset()
        elif BR110.stat(EINFAHRT,LINKS,4) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
            reset()
        elif BR110.stat(EINFAHRT,RECHTS,2):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,RECHTS,4):
                reset()
            elif BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3):
                if ICE.stat(BEREIT,LINKS,2):
                    reset()
                ...
                err()
        elif BR110.stat(GLEISWECHSEL,RECHTS,1) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            reset()
        elif BR110.stat(GLEISWECHSEL,RECHTS,4) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            reset()
        elif BR110.stat(NACH_LINKS,RECHTS,1) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3):
            if ICE.stat(AUSFAHRT,LINKS,2):
                reset()
            elif ICE.stat(BEREIT,RECHTS,4):
                reset()
            ...
            reset()
        elif BR110.stat(NACH_LINKS,RECHTS,4) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,1):
            reset()
        elif BR110.stat(NACH_RECHTS,LINKS,2):
            if BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1):
                if ICE.stat(BEREIT,RECHTS,4):
        ...
        if BR110.stat(AUSFAHRT,LINKS,2) and BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1):
            if ICE.stat(NACH_LINKS,RECHTS,2):
                reset()
            elif ICE.stat(NACH_LINKS,RECHTS,4):
                reset()
            ...
            reset()                
        elif BR110.stat(EINFAHRT,RECHTS,2) and BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(NACH_LINKS,RECHTS,2):
            reset()
            ...
            reset()                
        elif BR110.stat(NACH_RECHTS,LINKS,2) and BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1):
            if ICE.stat(NACH_LINKS,RECHTS,2):
                reset()
        ...
        if BR110.stat(AUSFAHRT,LINKS,2) and BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(NACH_LINKS,RECHTS,2):
            reset()            
        elif BR110.stat(BEREIT,LINKS,2):
            if BR118.stat(BEREIT,RECHTS,1):
                if BR130.stat(ABGEKUPPELT,LINKS,1):
                ...
                err()
        elif BR110.stat(BEREIT,RECHTS,1) and BR118.stat(EINGEFAHREN,LINKS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,LINKS,2):
            rand=random.choice([1,2,3,4,5,6])
            rand=2
            print "z1265"
            print "rand =",rand
            ...
            if BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,RECHTS,2):
                ...
                err()
        elif BR110.stat(EINFAHRT,RECHTS,2) and BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,LINKS,1):
            if ICE.stat(BEREIT,LINKS,2):
                reset()
            elif ICE.stat(EINFAHRT,LINKS,2):
                reset()
        ...
        if BR110.stat(EINFAHRT,LINKS,2) and BR118.stat(BEREIT,RECHTS,1) and BR130.stat(ABGEKUPPELT,RECHTS,3) and ICE.stat(BEREIT,RECHTS,4):
            reset()
        ...
        if BR110.stat(BEREIT,LINKS,2) and BR118.stat(BEREIT,RECHTS,1):
            if BR130.stat(ABGEKUPPELT,LINKS,1) and ICE.stat(BEREIT,RECHTS,2):
                reset()
